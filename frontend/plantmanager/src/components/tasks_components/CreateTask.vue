  ...
  <div class="my-container">
      <div class="form-wrapper">
            <form @submit.prevent="createTask" class="flex flex-col items-center">
                <DatePicker @setDate="setDate" ref="date"/>
                <input class="input-shadow padding-input width-input outline-clear mb-4 text-md border-b-2 border-gray-400 focus:border-green-500 focus:shadow-none" 
                name="title" type="text" v-model="title">
                <textarea class="padding-input width-input outline-clear shadow-md mb-5 text-md textarea border-2 rounded-md border-gray-500 focus:border-green-400 focus:shadow-none" 
