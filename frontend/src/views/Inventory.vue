            ...
            <div class="p-2 bg-white border rounded shadow">
              ...
              <ul>
                ...
                >
                  ...
                  <ul
                    :class="{
                      active: selectedPlantOfSeedlings === plantType.id,
                    }"
