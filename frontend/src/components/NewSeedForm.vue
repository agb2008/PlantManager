...
<!-- modal -->
		<div id="modal" class="transform relative w-10/12 md:w-1/2 h-1/2 md:h-3/4 px-6 py-12 bg-white rounded shadow-lg transition-opacity transition-transform duration-300"
		:class="modalClassObj">
			...
			<div class="relative z-0 w-full mb-5">
				...
				<option v-for="itemType in plantTypeList" :key="itemType.id"
			...
			<div class="relative z-0 w-full mb-5">
				...
				>
				<option value="" selected disabled hidden></option>
				<option v-for="itemManufact in manufacturerList" :key="itemManufact.id"
				:value="itemManufact.id">{{ itemManufact.name }}</option>
			...
			<div class="relative z-0 w-full mb-5">
				...
				/>
				<label for="date" class="absolute duration-300 top-3 -z-1 origin-0 text-gray-500">Дата упаковки семян</label>
			...
			<div class="relative z-0 w-full mb-5">
				<input
					...
					class="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200"
				/>
				<label for="date" class="absolute duration-300 top-3 -z-1 origin-0 text-gray-500">Дата сбора семян</label>
				<span class="text-sm text-red-600 hidden" id="error">Date is required</span>
			</div>
			<div class="relative z-0 w-full mb-5">
				<input
					...
					class="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200"
				/>
				<label for="date" class="absolute duration-300 top-3 -z-1 origin-0 text-gray-500">Срок годности до</label>
				<span class="text-sm text-red-600 hidden" id="error">Date is required</span>
			</div>
			<div class="relative z-0 w-full mb-5">
				<input
				...
				<label for="money" class="absolute duration-300 top-3 left-5 -z-1 origin-0 text-gray-500">Количество семян в пачке</label>
			...
			<div class="relative z-0 w-full mb-5">
				...
				/>
				<div class="absolute top-0 left-0 mt-3 ml-1 text-gray-400"></div>
				<label for="money" class="absolute duration-300 top-3 left-5 -z-1 origin-0 text-gray-500">Количество пачек</label>
				<span class="text-sm text-red-600 hidden" id="error">Amount is required</span>
			</div>
			<div class="relative z-0 w-full mb-5">
				<input
				...
				/>
				<div class="absolute top-0 left-0 mt-3 ml-1 text-gray-400"></div>
				<label for="money" class="absolute duration-300 top-3 left-5 -z-1 origin-0 text-gray-500">Цена за пачку</label>
				<span class="text-sm text-red-600 hidden" id="error">Amount is required</span>
			</div>
			<div class="group inline-block empty relative h-10 input-component mb-5">
					<input
						id="name"
						type="text"
						name="name"
