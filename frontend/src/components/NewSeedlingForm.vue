...
<!-- modal -->
		...
		:class="modalClassObj">
			...
			<div class="relative z-0 w-full mb-5">
				...
				/>
				<label for="date" class="absolute duration-300 top-3 -z-1 origin-0 text-gray-500">Дата приобретения</label>
			...
			<div class="relative z-0 w-full mb-5">
				<input
					...
					class="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200"
				/>
				<label for="date" class="absolute duration-300 top-3 -z-1 origin-0 text-gray-500">Дата посадки</label>
				<span class="text-sm text-red-600 hidden" id="error">Date is required</span>
			</div>
			...
			<div class="relative z-0 w-full mb-5">
				...
				<label for="money" class="absolute duration-300 top-3 left-5 -z-1 origin-0 text-gray-500">Количество саженцев</label>
			...
			<div class="relative z-0 w-full mb-5">
				...
				/>
				<div class="absolute top-0 left-0 mt-3 ml-1 text-gray-400"></div>
				<label for="money" class="absolute duration-300 top-3 left-5 -z-1 origin-0 text-gray-500">Цена за саженец</label>
				<span class="text-sm text-red-600 hidden" id="error">Amount is required</span>
			</div>
...
methods: {
	...
	saveData() {
		this.newData({'id': 19, 'name': this.plantName, 'typePlant': this.selectedPlant, 'amount': this.amount, 'price': this.price, 'manufacturerId': this.manufacturerId, 'purchaseDate': this.purchaseDate, 'plantDate': this.plantDate});
