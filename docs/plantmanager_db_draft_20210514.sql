...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 14 2021 г., 11:27
...
INSERT INTO `seedling` (`id`, `name`, `type_id`, `manufacturer_id`, `amount`, `img_id`, `notes`, `price`, `purchase_date`, `plant_date`, `seeds_id`) VALUES
(1, 'Ласточка F1', 1, 1, 6, 1, 'Описание к рассаде огурцов Ласточка F1', 0, NULL, '2021-05-14 08:19:55', NULL);
...
CREATE TABLE `seeds` (
  `id` bigint UNSIGNED NOT NULL,
  `name` varchar(255) NOT NULL,
  `number_of_seeds` int UNSIGNED NOT NULL DEFAULT '5',
  `amount` int UNSIGNED NOT NULL DEFAULT '1',
  `type_id` bigint UNSIGNED NOT NULL,
  `manafacturer_id` bigint UNSIGNED NOT NULL,
